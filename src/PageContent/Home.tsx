...
function Home() {
  ...
  return (
    <>
        {
          isMobile ? 
          <div className="w-full h-[80vh] flex justify-center items-center bg-[url('/assets/headphones/hero-xx99.png')] bg-cover bg-center">
          ...
          : <div className="w-full px-30">
              <div className="flex h-[630px] w-full bg-[url('/assets/headphones/image-hero.webp')] bg-contain bg-no-repeat">
        ...
        <div className="w-full bg-secondary-white min-h-screen pt-15 flex flex-col items-center gap-y-8 pb-10">
          ...
          <div className={`w-[80%] h-[560px] bg-primary-brown rounded-lg flex text-primary-white
            ...
            <div className="h-full pl-5 flex items-end">
              <img src="/assets/speakers/featured-speaker-image.png" alt="Featured Speaker" className="p-0" width={400}/>
            </div>
          ...
          <div className="w-[80%] h-80 bg-[url(/assets/speakers/2nd-featured-speaker.png)] 
            ...
            <div className="w-[40%] pl-5 h-full flex flex-col gap-y-5 justify-center items-center">
              {isMobile? <h4>ZX7 SPEAKER</h4> : <h3>ZX7 SPEAKER</h3>}
          ...
          <div className={`w-[80%] h-80 flex justify-between items-center ${isSmall ? "flex-col gap-y-5 h-140" : ""}`}>
            <div className={`w-[48%] h-full flex flex-col gap-y-5 justify-center 
                            items-center rounded-lg bg-[url(/assets/earphones/featured-earphones.png)] 
          ...
          {/* Business Story */}
          <div className={`${isMobile ? "w-full px-5 mt-10" : ""}`}>
